 ...
 */
final class Version20241116212402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE taller (id INT AUTO_INCREMENT NOT NULL, colectiva_id INT NOT NULL, t_nombre VARCHAR(64) NOT NULL, t_fecha_hora DATETIME NOT NULL, t_modalidad INT NOT NULL, t_tipo_taller VARCHAR(32) DEFAULT NULL, t_estado TINYINT(1) NOT NULL, INDEX IDX_139F45843FAAAEA5 (colectiva_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE temporada (id INT AUTO_INCREMENT NOT NULL, programa_id INT NOT NULL, tem_nombre VARCHAR(64) NOT NULL, tem_fecha_creacion DATETIME NOT NULL, tem_fecha_inicio DATETIME NOT NULL, tem_fecha_fin DATETIME NOT NULL, tem_estado TINYINT(1) NOT NULL, INDEX IDX_9A6BDEBDFD8A7328 (programa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
