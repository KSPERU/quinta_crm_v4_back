...
class Usuario implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Colaborador::class, mappedBy: 'usuario', orphanRemoval: true)]
    ...
    public function addColaboradore(Colaborador $colaboradore): static
    {
        if (!$this->colaboradores->contains($colaboradore)) {
            $this->colaboradores->add($colaboradore);
            $colaboradore->setUsuario($this);
        }

        return $this;
    }

    public function removeColaboradore(Colaborador $colaboradore): static
    {
        if ($this->colaboradores->removeElement($colaboradore)) {
            // set the owning side to null (unless already changed)
            if ($colaboradore->getUsuario() === $this) {
                $colaboradore->setUsuario(null);
            }
        }
